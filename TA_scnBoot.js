class TA_scnBoot extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("btn_highscore", "assets/btn_highscore.png");
    ...
    // FONT
    // =========================
    // Kalau kamu punya font.png + font.fnt, pakai ini.
    // Nama file font.png bisa kamu sesuaikan dengan asset kamu.
